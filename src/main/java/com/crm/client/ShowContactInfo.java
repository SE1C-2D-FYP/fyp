 ...
 * @author DennisC
 */
@WebServlet(name = "ShowContactInfo", urlPatterns = {"/ShowContactInfo"})
public class ShowContactInfo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        criteria.add(Restrictions.eq("clientId", new Client(id)));
        List<ContactInfo> contact = criteria.list();
